...
let user2 = { name: "Anderson" };

user1.sayName.call(user2);   // Anderson
...
greet.call(person, "Kanyakumari", "India");
...
let user = {name:"Shibin"};

greet.apply(user, ["KK", 26]);   // arguments comma-vachi


let num = [12,32,52,12,32,71];
...
let user1 = {
    name : "Shibin",
    info : function(place, age ){
        console.log("my name is :",this.name,place,age)
    }
}
...
let first = new user("Shibin");
let second = new user("shiyas")
